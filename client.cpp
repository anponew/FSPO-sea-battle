...
void Client::readAddress()
{
    ...
    do {
        QInputDialog i;
        text = i.getText(0, tr("What is server address?"), tr("Address:"), QLineEdit::Normal,"127.0.0.1", &ok);
...
void Client::writeToSocket(bool state)
{

    //socketClient->write(state);
...
void Client::connectToServer()
{
    ...
    qDebug() << this->address;
    socketClient->connectToHost(this->address, 1488, QTcpSocket::ReadWrite);
